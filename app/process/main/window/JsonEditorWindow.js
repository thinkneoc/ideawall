...
function creat(json) {
    ...
    xwindow.loadURL(url.format({
        pathname: path.join(__dirname, relative + "./view/components/JsonEditor.html"),
        protocol: 'file:',
        slashes: true
    }) + "?windowKey=_jsoneditorwindow&windowId=" + xwindow.id);
    ...
    xwindow.once('ready-to-show', () => {
        ...
        xwindow.webContents.send('ipc_window_jsoneditor_cgi', json);
